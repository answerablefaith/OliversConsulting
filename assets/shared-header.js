(() => {
  ...
  function addFooterFixStyles() {
    ...
    style.textContent = '#oc-site-footer nav{align-items:start!important;justify-items:start!important;text-align:left!important}#oc-site-footer nav a,#oc-site-footer div>a[href^="mailto:"]{display:block!important;width:auto!important;max-width:100%!important;justify-self:start!important;text-align:left!important;justify-content:flex-start!important;align-items:flex-start!important;padding-left:0!important;padding-right:0!important;background:transparent!important;border:0!important;box-shadow:none!important;color:#17130b!important}#oc-site-footer a[href="/articles/"],#oc-site-footer a[href="/#book"]{text-align:left!important;justify-self:start!important;width:auto!important}@media(max-width:900px){#oc-site-footer nav{display:grid!important;grid-template-columns:1fr!important;justify-items:start!important;text-align:left!important}#oc-site-footer nav a{font-size:24px!important;line-height:1.2!important;text-align:left!important;justify-self:start!important;width:auto!important}}';
