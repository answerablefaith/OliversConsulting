# aa0a52fe-50fe-439b-80a5-e8913a53ea51 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `Olivers-Consulting-v3.dc.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `Olivers-Consulting-v3.dc.html`
...
- A single self-contained `Olivers-Consulting-v3.dc.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `Olivers-Consulting-v3.dc.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
1. Inspect `Olivers-Consulting-v3.dc.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
